          ...
          {cartItems.length > 0 && (
            <div className="flex justify-end mb-4">
              <button
                ...
                className="px-6 py-2 bg-red-50 text-red-600 font-bold rounded-xl border border-red-100 hover:bg-red-600 hover:text-white hover:border-red-600 transition-all duration-300 active:scale-95 shadow-sm cursor-pointer"
              >
                Clear Cart
              </button>
            </div>
          ...
          {cartItems.length === 0 ? (
            ...
            <div className="p-4 md:p-8">
              ...
              <div className="mt-10 pt-8 border-t border-gray-100">
                ...
                <button className="w-full py-4 bg-green-600 text-white font-black text-lg rounded-2xl shadow-lg shadow-green-200 hover:bg-green-700 transition-all active:scale-[0.98] uppercase tracking-wider cursor-pointer">
                  Checkout
                </button>
              </div>
            </div>
